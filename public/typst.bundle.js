...
], pr = ["TwitterColorEmoji.ttf", "NotoColorEmoji.ttf"];
function br() {
  return ne([], { assets: !1 });
}
function mr(r) {
...
class U {
  ...
  constructor(e) {
    ...
    /** @internal */
    l(this, "exOptions");
    this.cc = (e == null ? void 0 : e.compiler) || U.buildLocalCompiler, this.ex = (e == null ? void 0 : e.renderer) || U.buildLocalRenderer, this.mainFilePath = "/main.typ", this.providers = [];
  }
  /**
...
const Dt = /* @__PURE__ */ new WeakMap(), Ue = /* @__PURE__ */ new WeakMap(), $t = /* @__PURE__ */ new WeakMap(), Le = /* @__PURE__ */ new WeakMap(), Qe = /* @__PURE__ */ new WeakMap();
function Pr(r) {
...
const Ur = (r) => new Ft(async (e) => await r.default(e));
function nt() {
  return new Wt();
}
function ni() {
...
let it = !0, Wt = class {
  ...
  async createWorkerV0(e) {
    return new Nr(this, await this.renderer.create_worker(e));
  }
  workerBridge() {
...
const Kr = [
  ...
  "Roboto-Regular.ttf",
  "NotoSerifCJKsc-Regular.otf"
], Qr = ["TwitterColorEmoji.ttf", "NotoColorEmoji.ttf"];
function Xr(r) {
  var t, n;
  const e = [];
  if (r && (r == null ? void 0 : r.assets) !== !1 && ((t = r == null ? void 0 : r.assets) != null && t.length) && ((n = r == null ? void 0 : r.assets) == null ? void 0 : n.length) > 0) {
...
const en = new Ut(async (r) => await (await Promise.resolve().then(() => Me)).default(r));
function Vt() {
  return new ye();
}
const Ce = class Ce {
...
const dn = (r) => new Ut(async (e) => await r.default(e));
function ln() {
  return new Kt();
}
let _t = !0;
class Kt {
  ...
  async init(e) {
    ...
    this.rendererJs = await (((n = e == null ? void 0 : e.getWrapper) == null ? void 0 : n.call(e)) || Promise.resolve().then(() => Ye));
    const t = this.rendererJs.TypstRendererBuilder;
    this.renderer = await Nt(e, dn(this.rendererJs), t, {});
  }
  loadGlyphPack(e) {
    return Promise.resolve();
  }
...
function vn(r, e) {
  p(r), p(e), c.__wbindgen_export_5(r, e);
}
function Sn(r, e, t) {
  p(r), p(e), c.__wbindgen_export_6(r, e, y(t));
}
function Cn(r, e, t) {
...
function Xt() {
  ...
  return r.wbg = {}, r.wbg.__wbg_appendChild_8204974b7328bf98 = function() {
    ...
    const n = !1;
    return j(n), n;
  }, r.wbg.__wbindgen_closure_wrapper1625 = function() {
    return h(function(e, t, n) {
      const i = lt(e, t, 134, vn);
      return y(i);
    }, arguments);
  }, r.wbg.__wbindgen_closure_wrapper1626 = function() {
    return h(function(e, t, n) {
      const i = lt(e, t, 134, Sn);
      return y(i);
    }, arguments);
  }, r.wbg.__wbindgen_closure_wrapper2253 = function() {
    return h(function(e, t, n) {
      const i = pn(e, t, 134, Cn);
      return y(i);
    }, arguments);
...
class de {
  ...
  current() {
    try {
      ...
      let i;
      return e !== 0 && (i = Dn(e, t).slice(), g.__wbindgen_export_1(e, t * 1, 1)), i;
    } finally {
...
class Ie {
  ...
  get_loaded_fonts() {
    try {
      ...
      var e = S().getInt32(i + 4 * 0, !0), t = S().getInt32(i + 4 * 1, !0), n = jn(e, t).slice();
  ...
  incr_compile(e, t, n, i) {
    try {
      const f = g.__wbindgen_add_to_stack_pointer(-16), w = B(e, g.__wbindgen_export_2, g.__wbindgen_export_3), P = T;
      var s = z(t) ? 0 : ge(t, g.__wbindgen_export_2), o = T;
      Bn(n, de), g.typstcompiler_incr_compile(f, this.__wbg_ptr, w, P, s, o, n.__wbg_ptr, i);
      var a = S().getInt32(f + 4 * 0, !0), d = S().getInt32(f + 4 * 1, !0), _ = S().getInt32(f + 4 * 2, !0);
      if (_)
        throw I(d);
      return I(a);
...
function ir() {
  ...
  }, r.wbg.__wbindgen_closure_wrapper16165 = function(e, t, n) {
    const i = Fn(e, t, 1133, Wn);
    return v(i);
  }, r.wbg.__wbindgen_debug_string = function(e, t) {
...
async function or(r) {
  ...
  const e = ir();
  (typeof r == "string" || typeof Request == "function" && r instanceof Request || typeof URL == "function" && r instanceof URL) && (r = fetch(r));
  const { instance: t, module: n } = await Nn(await r, e);
  return sr(t, n);
}
